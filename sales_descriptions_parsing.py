...
fields_file = '18th_cent_format_and_fields.txt'
...
db.fields_descriptions.drop()
# * *

# Descriptions fields

# Creating dictionaries so when we encounter a field name in the sales descriptions
...
# Sales descriptions actual data
