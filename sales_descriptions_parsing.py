...
fields_file = '18th_cent_descriptions_fields.xlsx'
...
for d in df.iterrows():
    ...
    db.descriptions_fields.save(field_doc)


print "Loading Sales Descriptions into DB from", descriptions_file
